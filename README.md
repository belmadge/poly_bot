...
- Hedge/sync/preco: `HEDGE_MIN_POSITION_SIZE`, `HEDGE_DELAY_SECONDS`, `MIN_PRICE_BOUND`, `MAX_PRICE_BOUND`, `MAX_BOOK_SPREAD_PCT`, `MAX_MIDPOINT_DEVIATION_RATIO`, `MAX_SYNC_AGE_SECONDS`
